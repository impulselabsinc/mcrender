...
##    vertices,textures,normals,faces, materials = load_obj("RaspberryPi.obj", DEFAULTBLOCK, MATERIALS)
   ...
   # trex
    COORDSSCALE = 0.5
    STARTCOORD = minecraft.Vec3(0,30,-70)
    CLEARAREA1 = minecraft.Vec3(-30, -10, -90)
    CLEARAREA2 = minecraft.Vec3(30, 10, -50)
    DEFAULTBLOCK = [block.WOOL.id,6]
    MATERIALS = {}
    SWAPYZ = False
    vertices,textures,normals,faces, materials = load_obj("t-rex.obj", DEFAULTBLOCK, MATERIALS)
